#!/usr/bin/env bash
# scripts/test_mambavision_small_nam_input_sod.sh

cd /home/MLab

python test.py \
  --network models.networks.mambavision_small_nam_input_sod \
  --checkpoint runs/mambavision_small_nam_input_sod_duts/checkpoints/final.pth \
  ...
  --output-dir runs/mambavision_small_nam_input_sod_duts/test/DUTS-TE \
