...
from losses.small_foreground_loss import (
    SmallForegroundAwareSODLoss,
)
from train import (
    build_model,
    load_checkpoint,
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Train an SOD network with "
            "small-foreground-aware optimization."
        ),
    )
    ...
    parser.add_argument(
        ...
        default=0.5,
        help=(
            "Weight of the small-foreground-aware "
            "regularizer added to the final prediction."
        ),
    )
    ...
    parser.add_argument(
        ...
        default=0.5,
        help=(
            "Exponent controlling how strongly foreground "
            "area ratio affects foreground weighting."
        ),
    )
    ...
    parser.add_argument(
        ...
        default=2.0,
        help=(
            "Focal hardness exponent. Higher values suppress "
            "easy foreground/background pixels more strongly."
        ),
    )
    ...
    parser.add_argument(
        ...
        default=8.0,
        help=(
            "Maximum raw foreground scale before per-image "
            "normalization."
        ),
    )
    ...
    parser.add_argument(
        "--run-dir",
        default="runs/resnet18_baseline_sfa",
    )
...
def main() -> None:
    ...
    # 同时保存这次实验自己的 train/loss 源码，
    # 防止以后无法确认某个 checkpoint 到底用了哪版 loss。
