...
class VMambaSmallFPNNAMLabPyramidContextSOD(
    VMambaSmallFPNNAMLabHybridSOD
):
    """
    ...
    Controlled change from:
        vmamba_small_fpn_namlab_hybrid_sod.py
    ...
    Everything else remains unchanged:
        ...
        - all FPN lateral projections
        - 128-channel pure FPN
        - top-down addition
        - 3x3 FPN refinement
        - prediction heads
...
def build_model(
) -> VMambaSmallFPNNAMLabPyramidContextSOD:
    return VMambaSmallFPNNAMLabPyramidContextSOD(
        pretrained_path=PRETRAINED_PATH,
