#!/usr/bin/env bash
# scripts/train_mv_nam_four_scan_eorssd.sh
...
RUN_DIR="${RUN_DIR:-runs/mv_nam_four_scan_eorssd}"
...
echo "Mamba paths per NAM-guided block: 4"

python train.py \
    --network models.networks.mambavision_small_nam_four_scan_sod \
    --run-dir "${RUN_DIR}" \
