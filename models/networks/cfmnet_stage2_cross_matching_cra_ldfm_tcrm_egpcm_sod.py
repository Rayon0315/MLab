# models/networks/cfmnet_stage2_cross_matching_cra_ldfm_tcrm_egpcm_sod.py
...
class CFMNetStage2CrossMatchingCRALDFMTCRMEGPCMSOD(CFMNetStage2CrossMatchingUNetFormerSOD):
    """
    CRA Step 3: Step 2 + M60 spatial context adapts Stage2 EGPCM.
...
def build_model() -> CFMNetStage2CrossMatchingCRALDFMTCRMEGPCMSOD:
    pretrained_path = (
        PRETRAINED_PATH
    ...
    return CFMNetStage2CrossMatchingCRALDFMTCRMEGPCMSOD(
        pretrained_path=pretrained_path,
        decode_channels=64,
        window_size=8,
        matching_window=7,
