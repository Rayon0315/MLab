"""SACA-v2 ablation: remove FG/BG semantic relevance refinement."""
...
class CFMNetF23IRAMSACAv2WoSemanticRelevanceUNetFormerSOD(CFMNetIRAMStrongStreamSOD):
    def __init__(self, pretrained_path):
        super().__init__(
            pretrained_path=pretrained_path,
            x_stream=SACAv2Stream(ablation="no_semantic_relevance"),
        )


def build_model():
    return CFMNetF23IRAMSACAv2WoSemanticRelevanceUNetFormerSOD(
