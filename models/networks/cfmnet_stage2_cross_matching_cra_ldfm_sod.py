# models/networks/cfmnet_stage2_cross_matching_cra_ldfm_sod.py
...
class CFMNetStage2CrossMatchingCRALDFMSOD(CFMNetStage2CrossMatchingUNetFormerSOD):
    """
    CRA Step 1: RGB-M60 region-relative detail adapts Stage2 LDFM only.
...
def build_model() -> CFMNetStage2CrossMatchingCRALDFMSOD:
    pretrained_path = (
        PRETRAINED_PATH
    ...
    return CFMNetStage2CrossMatchingCRALDFMSOD(
        pretrained_path=pretrained_path,
        decode_channels=64,
        window_size=8,
        matching_window=7,
