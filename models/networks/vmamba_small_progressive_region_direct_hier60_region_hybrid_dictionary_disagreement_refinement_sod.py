# models/networks/vmamba_small_progressive_region_direct_hier60_region_hybrid_dictionary_disagreement_refinement_sod.py
...
class DisagreementAwareFGBGRefinement(nn.Module):
    """
    ...
    Two regions receive stronger correction:
        1. uncertain pixels
        2. confident pixels whose visual evidence contradicts the prediction
    """
...
class VMambaSmallProgressiveRegionDirectHier60RegionHybridDictionaryDisagreementRefinementSOD(
    VMambaSmallProgressiveRegionDirectHier60RegionHybridDictionaryRoutingSOD
):
    """
    ...
    Dictionary model. Only one lightweight gated residual correction is added.
    """
    ...
    def __init__(
        ...
        self.disagreement_refinement = (
            DisagreementAwareFGBGRefinement(
                channels=128,
                signal_channels=32,
                prototype_gamma=4.0,
