# models/networks/mambavision_small_nam_input_sod.py
...
class MambaVisionSmallNAMInputSOD(nn.Module):
    """
    MambaVision-Small RGB + NAMLab input-level fusion.

    Input:
        image:  [B, 3, H, W]
        nam_40: [B, 1, H, W]

    The RGB image and NAM hier_40 map are concatenated into
    a four-channel input before entering MambaVision.
    ...
    Decoder:
        Identical to MambaVisionSmallSOD baseline.
    """
    ...
    def __init__(
        ...
        self._replace_input_convolution()
    ...
    def _replace_input_convolution(
        self,
    ) -> None:
        rgb_conv: nn.Conv2d = (
            self.backbone
...
def build_model() -> MambaVisionSmallNAMInputSOD:
    return MambaVisionSmallNAMInputSOD(
        pretrained_path=PRETRAINED_PATH,
