# models/components/cfm_blocks.py
...
class CFMBlock(nn.Module):
    ...
    Split one feature into four complementary channel subspaces:

        TCRM | SSRM | LDFM | EGPCM

    and fuse them back to the original channel dimension.
    """
