# models/networks/mambavision_sod.py
...
class MambaVisionSOD(nn.Module):
    """
    MambaVision-T RGB SOD 网络。

    Backbone:
        stage1: stride 4,  channels 80
        stage2: stride 8,  channels 160
        stage3: stride 16, channels 320
        stage4: stride 32, channels 640
