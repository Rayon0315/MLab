# models/networks/mambavision_small_hecm_reassembly_sod.py
...
from models.components.nam_reassembly import (
    HierarchicalStructureReassemblyFusion,
)
...
class MambaVisionSmallHECMReassemblySOD(nn.Module):
    """
    MambaVision-Small SOD with progressive H-ECM construction and
    hierarchy-guided semantic reassembly.

    NAM hierarchy assignment:
        hier_20 -> decoder stage 3, stride 16
        hier_40 -> decoder stage 2, stride 8
        hier_60 -> decoder stage 1, stride 4
    """
...
def build_model() -> MambaVisionSmallHECMReassemblySOD:
    return MambaVisionSmallHECMReassemblySOD(
        pretrained_path=PRETRAINED_PATH,
