#!/usr/bin/env bash
# scripts/train_mv_progressive_region_direct_hier60_region_hybrid_eorssd_aug8.sh
...
python train.py \
    ...
    --run-dir runs/mv_progressive_region_direct_hier60_region_hybrid_eorssd_aug8_e45 \
