...
from models.components.cfm_structure_refinement import (
    DirectionalThinStructureRecovery,
    Stage1StructureTap,
)
...
class CFMNetGlobalLocalThinStructureRecoverySOD(
    CFMNetGlobalLocalBranchUNetFormerSOD
):
    input_keys = ("image",)
    ...
    def __init__(
        ...
        self.thin_recovery = DirectionalThinStructureRecovery(
...
def build_model():
    ...
    return CFMNetGlobalLocalThinStructureRecoverySOD(
        pretrained_path=pretrained_path,
        decode_channels=64,
        window_size=8,
    )
