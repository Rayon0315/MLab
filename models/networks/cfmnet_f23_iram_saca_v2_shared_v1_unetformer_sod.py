"""CFMNet + F2/F3 IRAM + SACA-v2 front-end + SACA-v1 shared cooperation."""

from models.components.cfm_iram_saca_v2_cooperation_variants import (
    SACAv2SharedV1CooperationStream,
)
...
class CFMNetF23IRAMSACAv2SharedV1UNetFormerSOD(
    CFMNetIRAMStrongStreamSOD
):
    def __init__(self, pretrained_path):
        super().__init__(
            pretrained_path=pretrained_path,
            x_stream=SACAv2SharedV1CooperationStream(),
        )


def build_model():
    return CFMNetF23IRAMSACAv2SharedV1UNetFormerSOD(
