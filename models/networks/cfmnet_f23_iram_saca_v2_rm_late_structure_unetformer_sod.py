"""SACA-v2 + Region-Mean late structural evidence."""
...
class CFMNetF23IRAMSACAv2RMLateStructureUNetFormerSOD(
    CFMNetIRAMSACARegionMeanStructuralSOD
):
...
def build_model():
    return CFMNetF23IRAMSACAv2RMLateStructureUNetFormerSOD(
