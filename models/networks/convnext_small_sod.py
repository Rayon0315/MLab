# models/networks/convnext_small_sod.py
...
from models.backbones.convnext import (
    ConvNeXtBackbone,
    convnext_small,
)
...
class ConvNeXtSmallSOD(nn.Module):
    """
    ConvNeXt-S RGB SOD network.
    ...
    Decoder:
        pyramid context
        -> coarse-to-fine saliency-guided fusion
        -> shallow boundary refinement
...
def build_model() -> ConvNeXtSmallSOD:
    return ConvNeXtSmallSOD(
        pretrained_path=PRETRAINED_PATH,
